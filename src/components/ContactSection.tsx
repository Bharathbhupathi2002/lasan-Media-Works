  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {contactInfo.map((item, index) => (
              ...
              >
                ...
                <p className="text-gray-600 mb-3">{item.value}</p>
        ...
        >
          <div className="max-w-md mx-auto bg-gradient-to-r from-blue-100 to-purple-100 p-6 rounded-xl shadow-md">
      ...
      <div className="absolute top-20 left-10 w-24 h-24 bg-blue-200 rounded-full opacity-30 blur-xl"></div>
      <div className="absolute bottom-40 right-10 w-36 h-36 bg-purple-200 rounded-full opacity-30 blur-xl"></div>
    </motion.div>
  );
};
